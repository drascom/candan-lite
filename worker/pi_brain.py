    ...
    class PiBrain(llm.LLM):
        ...
        def _enroll_hint(self, text: str) -> str:
            ...
            return (
                ...
                "3) Ses örneği: birkaç saniye doğal konuşmasını iste. Kimlik kaydı "
                "tamamlanınca worker, etiketli duygu ve serbest konuşma örneklerini "
                "kendisi sırayla toplayacak; bu bölümü sen yürütme.\n"
