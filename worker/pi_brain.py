    ...
    class PiBrain(llm.LLM):
        ...
        def _enroll_hint(self, text: str) -> str:
            ...
            return (
                ...
                "4) Onaydan sonra AYNEN şu bilgiyi ver: 'Teşekkür ederim. Şimdi ses kaydınızı "
                "alacağım. Lütfen normal bir sesle: Bugün kendimi iyi hissediyorum, deyin.' "
                "Bu nötr cümle söylendikten sonra enroll_speaker tool'unu çağır.\n"
                "5) Kaydı tool yapar: "
